...
PASSIVE_DETAILS = {
    ...
    "berserker":        {"name": "Berserker",         "effect": "Damage increases up to +50% as HP drops, capped at 30% HP", "type": "Offense"},
    "shield_matrix":    {"name": "Shield Matrix",     "effect": "Block one hit every 5 seconds", "type": "Defense"},
